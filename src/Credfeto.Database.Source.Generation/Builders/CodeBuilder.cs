...
namespace Credfeto.Database.Source.Generation.Builders;
...
public sealed class CodeBuilder
{
    ...
    {
        return this.AppendLine($"[GeneratedCode(tool: \"{VersionInformation.Product}\", version: \"{VersionInformation.Version}\")]");
    }
