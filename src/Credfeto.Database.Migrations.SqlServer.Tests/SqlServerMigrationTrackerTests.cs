...
using Credfeto.Database.Migrations.SqlServer.Tests.Helpers;
using FunFair.Test.Common;
using Xunit;

namespace Credfeto.Database.Migrations.SqlServer.Tests;

public sealed class SqlServerMigrationTrackerTests : TestBase
{
    [Theory]
    [InlineData("")]
    ...
    {
        SqlServerMigrationTracker tracker = new();
    ...
    {
        SqlServerMigrationTracker tracker = new(new MigrationRunnerOptions("custom_migrations"));
